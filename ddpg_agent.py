...
NOISE_DECAY = 0.999
LEARN_EVERY_STEPS = 20        # learning very number of timesteps
UPDATE_RATE = 10         # number of updates per step
...
class ReplayBuffer:
    ...
    def __init__(self, action_size, buffer_size, batch_size, seed, num_agents = 1):
